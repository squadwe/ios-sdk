...
class ConversationDetailsViewController: ChatViewController {
    ...
    override func viewDidLoad() {
        ...
        if selectedConversation != nil && selectedConversation.messages.count > 0 {
            ...
            updateTitleView(title: lastMessage.sender?.senderName ?? "Squadwe", subtitle: "")
        }
        else {
            updateTitleView(title: "Squadwe" , subtitle: "")
        }
    }
    ...
    func setTypingIndicatorViewHidden(_ isHidden: Bool, performUpdates updates: (() -> Void)? = nil) {
        updateTitleView(title: "Squadwe", subtitle: isHidden ? "2 Online" : "Typing...")
